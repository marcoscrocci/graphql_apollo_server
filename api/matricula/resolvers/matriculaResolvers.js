...
const matriculaResolvers = {
    ...
    Mutation: {
        ...
        excluirMatricula: (_, { matricula }, { dataSources }) => dataSources.matriculasAPI.excluirMatricula(matricula),
        cancelarMatricula: (_, { matricula }, { dataSources }) => dataSources.matriculasAPI.cancelarMatricula(matricula)
    },

    Matricula: {
        estudante: (parent, args, { dataSources }) => dataSources.usersAPI.getUserById(parent.estudante_id),
        turma: (parent, args, { dataSources }) => dataSources.turmasAPI.getTurma(parent.turma_id)
    }
}
